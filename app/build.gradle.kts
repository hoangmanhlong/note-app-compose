...
dependencies {
    ...
    implementation("com.google.dagger:hilt-android:${rootProject.extra["dagger_hit_version"]}")
    ksp("com.google.dagger:hilt-android-compiler:${rootProject.extra["dagger_hit_version"]}")
